...
```sh
curl --location 'https://dn1zcoukgk:uzk35ys1og@unir-search-1537709488.us-east-1.bonsaisearch.net:443/_aliases' \
...
```sh
curl --location 'https://dn1zcoukgk:uzk35ys1og@unir-search-1537709488.us-east-1.bonsaisearch.net:443/employees-alias/_doc/' \
--header 'Content-Type: application/json' \
--data '{
    "FirstName": "MARIA",
    "LastName": "GOMEZ",
...
```sh
curl --location 'https://dn1zcoukgk:uzk35ys1og@unir-search-1537709488.us-east-1.bonsaisearch.net:443/employees-alias/_doc/8U_Qe5QBJNYMKW3QJ6oY'
```

4. Elimina el elemento que has creado anteriormente.

```sh
curl --location --request DELETE 'https://dn1zcoukgk:uzk35ys1og@unir-search-1537709488.us-east-1.bonsaisearch.net:443/employees-alias/_doc/8U_Qe5QBJNYMKW3QJ6oY'
```

5.1. Obtener empleados cuyo puesto sea Software Engineer.

```sh
curl --location --request GET 'https://dn1zcoukgk:uzk35ys1og@unir-search-1537709488.us-east-1.bonsaisearch.net:443/employees-alias/_search' \
--header 'Content-Type: application/json' \
--data '{
    "query": {
        "term": {
...
```sh
curl --location 'https://dn1zcoukgk:uzk35ys1og@unir-search-1537709488.us-east-1.bonsaisearch.net:443/employees-alias/_search' \
--header 'Content-Type: application/json' \
--data '{
    "query": {
        "bool" : {
