...
public class DepartmentsDao {
    ...
    public Object bestPaidEmployee(String deptName) throws SQLException {
        Query<Object> query = session.createNativeQuery("SELECT e.first_name, e.last_name, s.salary, d.dept_name " +
    ...
    public Object bestSecondPaidEmployee(String deptName) throws SQLException {
        Query<Object> query = session.createNativeQuery("SELECT e.first_name, e.last_name, s.salary, d.dept_name " +
                "FROM employees.employees e " +
                "JOIN employees.salaries s ON e.emp_no = s.emp_no " +
                "JOIN employees.dept_emp de ON e.emp_no = de.emp_no " +
