...
public class MySqlApplication {
    ...
    public static void main(String[] args) {
        ...
        try (Session session = HibernateMySqlConfig.getSessionFactory().openSession()) {
            ...
            Employee jesus = employeesDao.getById(10001);
            ...
            List<Object[]> genderCounts = employeesDao.countByGender();
            log.info("Count by Gender: {}", genderCounts);

            Object topPaidEmployee = departmentsDao.bestPaidEmployee("Sales");
            log.info("Top best Paid Employee: {}", topPaidEmployee);

            Object bestSecondPaidEmployee = departmentsDao.bestSecondPaidEmployee("Sales");
            log.info("Best Second Paid Employee: {}", bestSecondPaidEmployee);

            Object employeesByHiringMonth = employeesDao.employeesByHiringMonth(8);
            log.info("Employees By Hiring Month: {}", employeesByHiringMonth);
