...
public class DepartmentController {
     ...
     *
     * @param deptNo - id del departamento.
     * @return departamento.
     */
    @GetMapping("/byId/{id}")
    public ResponseEntity<Department> getDepartmentByNo(@PathVariable("id") String deptNo) {
        return ResponseEntity.ok(departmentRepository.findByDeptNo(deptNo).orElse(null));
    }

    /**
     * Buscar departamentos por nombre incompleto.
     *
     * @param partialName - parte del nombre del departamento.
     * @return lista de departamentos cuyo nombre contiene el texto proporcionado.
     */
    @GetMapping("/search")
